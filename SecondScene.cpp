...
void SecondScene::drawMapCellInfo()
{
	char cellIndex[1024];
...
void SecondScene::AstarTileInfo()
{
...
void SecondScene::rectMoveToPath()
{
...
POINT SecondScene::lerp(POINT start, POINT end, float percentage)
{
