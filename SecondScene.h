...
#define TEXTNumTWO 55
#define BgImageNUMTWO 5
#define SELECTNUM 15
...
public:
	...
	}, _text
	{
		...
		L"[셰라자드]",{"sheherazade"},L"이방에서 나가세요!저는 당신을 인정할수 없습니다!",//vermont 밀침?
		...
		L"[버몬트]",{"vermont"},L"흥!네놈의 이야기는 들었다.요새 두개가 네녀석에게 박살이 났더군.자, 어서 그 칼을 버리지 않으면, 이 여자를 두번다시 볼수 없을 것이다.",
		...
		L"[셰라자드]",{"sheherazade"},L"언젠가...말씀하셨죠...저에게 이 투르의 빛이 되어달라고...하지만 이젠 살라딘님만이 할수있어요...이 투르와 팬드래건...아니 온 세상 모든 사람들의 빛이 되어 주실수 있겠죠... ?",
		...
		saladin 불쌍한 인간!
		 ...
		 ====================================
		*/
		L"vermont",{"vermont"},L"죽여라...",
		L"saladin",{"saladin"},L"...",
		L"vermont",{"vermont"},L"그것만은... 제발 돌려줘 그것만은...",
