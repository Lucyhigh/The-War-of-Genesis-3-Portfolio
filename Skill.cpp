...
void Skill::worldBrokenSkill()
{
	...
	pushCellFrontSkill(172, "fire", cellPosIdx++, (BYTE)190, 10);
	pushCellFrontSkill(172, "fireL", cellPosIdx++, (BYTE)190, 10);
	pushCellFrontSkill(180, "one", cellPosIdx++, (BYTE)190, 10);
	pushCellFrontSkill(220, "95light", cellPosIdx++, (BYTE)190, 20);
	pushCellFrontSkill(235, "48fire", cellPosIdx++, (BYTE)190, 15);
	pushCellFrontSkill(235, "115stone", cellPosIdx++, (BYTE)210, 20);
	pushCellFrontSkill(235, "enemyAttack", cellPosIdx++, (BYTE)190, 10);
